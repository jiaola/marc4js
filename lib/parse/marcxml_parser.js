...
MarcxmlParser.prototype.handleEnd = function (){
    ...
    this.stream.removeEventListener('opentag', this.handleOpenObject.bind(this));
    this.stream.removeEventListener('closetag',this.handleCloseObject.bind(this));
    this.stream.removeEventListener('text', this.handleValue.bind(this));
    this.stream.removeEventListener('cdata', this.handleKey.bind(this));
