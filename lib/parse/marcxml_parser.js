...
MarcxmlParser.prototype.handleEnd = function (){
    ...
    this.stream.removeListener('opentag', this.handleOpenObject.bind(this));
    this.stream.removeListener('closetag',this.handleCloseObject.bind(this));
    this.stream.removeListener('text', this.handleValue.bind(this));
    this.stream.removeListener('cdata', this.handleKey.bind(this));
    this.stream.removeListener('end', this.handleEnd.bind(this));
    this.push(null);
};
