...
MijParser.prototype.handleEnd = function (){
    this.stream.removeEventListener('error', this.handleSaxError.bind(this));
    this.stream.removeEventListener('openobject', this.handleOpenObject.bind(this));
    this.stream.removeEventListener('closeobject',this.handleCloseObject.bind(this));
    this.stream.removeEventListener('value', this.handleValue.bind(this));
    this.stream.removeEventListener('key', this.handleKey.bind(this));
    this.stream.removeEventListener('end', this.handleEnd.bind(this));
    this.push(null);
};
