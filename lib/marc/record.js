...
Record.prototype.variableField = function (tag) {
    return this.variableFields(tag)[0];
};

Record.prototype.controlNumbers = function () {

};

Record.prototype.find = function (val) {
